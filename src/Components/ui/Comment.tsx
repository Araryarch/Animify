...
interface Comment {
  id: number // Ensure the unique identifier is included
  quote: string
  name: string
  title: string
}
  ...
  return (
    ...
    >
      <ul
        ref={scrollerRef}
        className={cn(
          'flex min-w-full shrink-0 gap-4 py-10',
          'w-full flex-nowrap',
      ...
      >
        {items.map((item) => (
          <li
            ...
            className="w-full relative rounded-2xl border border-b-0 flex-shrink-0 border-slate-700 px-8 py-12 md:w-[450px]"
            style={{
              background:
